...
function createTokenTypeSection(
  ...
  if (config.layout === 'grid') {
    ...
    cardsContainer.paddingTop = 0;
    cardsContainer.paddingRight = 0;
    cardsContainer.paddingLeft = 0;
    cardsContainer.paddingBottom = 0;
  } else {
...
function createDocumentationFrame(
  ...
  docFrame.paddingTop = 64;
  docFrame.paddingRight = 64;
  docFrame.paddingBottom = 64;
  docFrame.paddingLeft = 64;
