...
export const attachLocalStylesToTheme: AsyncMessageChannelHandlers[AsyncMessageTypes.ATTACH_LOCAL_STYLES_TO_THEME] =
  async (msg) => {
    const { theme, tokens, category, settings } = msg;
