...
export const useADO = () => {
  ...
  const syncTokensWithADO = React.useCallback(
    ...
    [askUserIfPull, dispatch, pushTokensToADO, storageClientFactory, themes, tokens, checkAndSetAccess],
  );
  ...
  const addNewADOCredentials = React.useCallback(
    ...
    [dispatch, tokens, themes, usedTokenSet, activeTheme, syncTokensWithADO],
  );
