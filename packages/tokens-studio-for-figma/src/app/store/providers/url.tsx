...
export default function useURL() {
  ...
  const storageClientFactory = useCallback(
    (context: UrlCredentials) => new UrlTokenStorage(context.id, context.secret),
    [],
  );

  // Read tokens from URL
  const pullTokensFromURL = useCallback(
    async (context: UrlCredentials): Promise<RemoteResponseData | null> => {
    ...
    [dispatch, storageClientFactory, activeTheme, usedTokenSets],
  );
