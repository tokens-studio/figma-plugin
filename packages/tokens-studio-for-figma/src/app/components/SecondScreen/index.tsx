...
import { Link1Icon, LinkBreak1Icon, EnterIcon, ExitIcon, ExternalLinkIcon } from '@radix-ui/react-icons';
import { useTranslation } from 'react-i18next';
import { Box, Stack, Button, Heading, Switch } from '@tokens-studio/ui';
    ...
    <Box className="content scroll-container">
      <Stack direction="column" gap={4} css={{ padding: '$3 0' }}>
        <Stack direction="column" gap={2} css={{ padding: '0 $4' }} justify="between" align="start">
          <Heading>
            Second Screen <StyledBetaBadge>BETA</StyledBetaBadge>
          </Heading>
          <StyledP>
