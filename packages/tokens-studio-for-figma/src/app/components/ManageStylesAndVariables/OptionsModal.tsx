...
import { Stack, Label, Box, Button, Switch, Text } from '@tokens-studio/ui';
      ...
      <Stack direction="column" align="start" gap={4}>
        ...
        <form>
          <Stack direction="column" gap={6}>
            <Box>
              <Text bold css={{ fontSize: '$medium', marginBottom: '$2' }}>
                {t('options.createAndUpdate')}
              </Text>
              <Box
                css={{
                  width: '100%',
              ...
              >
                <Stack direction="column" gap={3}>
                  ...
                  <LabelledCheckbox
                    id="variablesColor"
                    onChange={handleExportVariablesColor}
                    checked={!!variablesColor}
                    label={t('variables.color')}
                  />
                  <LabelledCheckbox
                    id="variablesString"
                    onChange={handleExportVariablesString}
                    checked={!!variablesString}
                    label={t('variables.string')}
                  />
                  <LabelledCheckbox
                    id="variablesNumber"
                    onChange={handleExportVariablesNumber}
                    checked={!!variablesNumber}
                    label={t('variables.number')}
                  />
                  <LabelledCheckbox
                    id="variablesBoolean"
                    onChange={handleExportVariablesBoolean}
                    checked={!!variablesBoolean}
                    label={t('variables.boolean')}
                  />
                </Stack>
                ...
                <Stack direction="column" gap={3}>
                  ...
                  <LabelledCheckbox
                    id="styleColor"
                    onChange={handleExportStylesColor}
                    checked={!!stylesColor}
                    label={t('styles.color')}
                  />
                  <LabelledCheckbox
                    id="stylesTypography"
                    onChange={handleExportStylesTypography}
                    checked={!!stylesTypography}
                    label={t('styles.typography')}
                  />
                  <LabelledCheckbox
                    id="stylesEffect"
                    onChange={handleExportStylesEffect}
                    checked={!!stylesEffect}
                    label={t('styles.effects')}
                  />
                </Stack>
              </Box>
            </Box>
            <StyledCheckboxGrid>
              <Text bold css={{ fontSize: '$medium', gridColumnStart: 1, gridColumnEnd: 4 }}>
                {t('options.tokensExportedToFigmaShould')}
              </Text>
              <Switch
              ...
              />
              <Label css={{ fontWeight: '$sansRegular', fontSize: '$xsmall' }} htmlFor="ignoreFirstPartForStyles">
                {t('options.ignorePrefix')}
              </Label>
              ...
              />
              <Label css={{ fontWeight: '$sansRegular', fontSize: '$xsmall' }} htmlFor="prefixStylesWithThemeName">
                {t('options.prefixStyles')}
              </Label>
              ...
              />
              <Label
                css={{ fontWeight: '$sansRegular', fontSize: '$xsmall' }}
                htmlFor="createStylesWithVariableReferences"
              >
                {t('options.createStylesWithVariableReferences')}
              </Label>
              ...
              />
              <Label css={{ fontWeight: '$sansRegular', fontSize: '$xsmall' }} htmlFor="renameExisting">
                {t('options.renameExisting')}
              </Label>
              ...
              />
              <Label css={{ fontWeight: '$sansRegular', fontSize: '$xsmall' }} htmlFor="removeWithoutConnection">
                {t('options.removeWithoutConnection')}
              </Label>
