...
describe('TermsUpdateModal', () => {
  ...
  it('shows the announcement for Pro users on the start screen', () => {
    ...
    expect(
      screen.getByText(
        'We have updated our Terms and Conditions, which will come into effect on August 16th, 2026. The changes include adding a new Subprocessor (Render.com) and improvements around our license portal. This notice is dated July 17th, 2026.',
      ),
    ).toBeInTheDocument();
