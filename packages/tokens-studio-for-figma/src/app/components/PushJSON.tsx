            ...
            tokenList.length > 0 && (
              <>
                ...
                {!collapsedChangedStateList.includes(tokenSet) && tokenList && (
                  <StyledJSONContent>{stringifyTokens(tokens, tokenSet, storeTokenIdInJsonEditor)}</StyledJSONContent>
                )}
              </>
            ),
        )}
      {themes.length > 0 && (
        <>
          ...
          {!collapsedChangedStateList.includes('$themes') && (
            <StyledJSONContent>{JSON.stringify(themes, null, 2)} </StyledJSONContent>
          )}
        </>
      )}
      {Object.keys(tokens).length > 0 && (
        <>
          ...
          {!collapsedChangedStateList.includes('$metadata') && (
            <StyledJSONContent>{JSON.stringify(Object.keys(tokens), null, 2)}</StyledJSONContent>
          )}
        </>
      )}
    </Stack>
