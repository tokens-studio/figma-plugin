...
import { Button, Stack, Text, Heading, Link } from '@tokens-studio/ui';
import Modal from './Modal';
import { useBitbucketMigration } from '@/app/hooks/useBitbucketMigration';

export default function BitbucketMigrationDialog() {
  const { showDialog, appPasswordCredentials, closeDialog, handleMigrate, checkAndShowMigrationDialog } =
