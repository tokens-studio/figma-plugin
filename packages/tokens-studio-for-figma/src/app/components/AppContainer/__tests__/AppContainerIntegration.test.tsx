...
import { screen, createMockStore, render, waitFor, fireEvent } from '../../../../../tests/config/setupTest';
...
const withOrWithoutLicense =
  (params: Omit<StartupMessage, 'licenseKey'>, fn: (parmas: StartupMessage) => Promise<void>) => async () => {
    await fn({
      ...params,
      licenseKey: null,
    });
