...
export async function getLdFlags(store: Store<RootState>, ldClientPromise: Promise<LDClient>, params: StartupMessage) {
  const { user } = params;
  ...
  console.log('Getting ld flags', licenseKey, clientEmail, user);
