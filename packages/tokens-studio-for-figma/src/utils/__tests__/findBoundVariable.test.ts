...
describe('findBoundVariable', () => {
  ...
  it('returns a function that checks for bound variables', () => {
    const result = findBoundVariable({} as TextStyle, 'fontSize', [], mockCompareValue);
  ...
  it('checks for bound variable and returns true if found', () => {
    ...
    const mockLocalVariables = [{ id: 'var1', name: 'font-size/54' } as Variable];

    const result = findBoundVariable(mockStyle, 'fontSize', mockLocalVariables, mockCompareValue);
  ...
  it('falls back to compareValue when bound variable is not found', () => {
    ...
    const mockLocalVariables = [{ id: 'var2', name: 'font-size/other' } as Variable];
