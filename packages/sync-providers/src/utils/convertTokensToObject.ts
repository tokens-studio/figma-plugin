...
import { appendTypeToToken } from './createTokenObj';
import type { AnyTokenList, AnyTokenSet } from '../types';
import { getGroupTypeName } from './stringifyTokens';
import { removeTokenId } from './removeTokenId';
import { setTokenKey, FormatSensitiveTokenKeys } from './set';

export function convertTokensToObject(tokens: Record<string, AnyTokenList>, storeTokenIdInJsonEditor: boolean) {
