...
// export default class RemoteTokens {
//   private api: any;
...
//   public async restoreStoredProvider(context: StorageTypeCredentials) {
...
//     };
//   }
//   public async deleteProvider(provider) {
//     AsyncMessageChannel.ReactInstance.message({
//       type: AsyncMessageTypes.REMOVE_SINGLE_CREDENTIAL,
//       context: provider,
//     });
//   }
//   public async pullTokens({
...
//       return remoteData;
//   }
//   public async pushTokens({ context = api, overrides }: { context?: StorageTypeCredentials, overrides?: PushOverrides } = {}) {
...
//       }
//   }
//   public async addNewProviderItem(credentials: StorageTypeFormValues<false>): Promise<RemoteResponseStatus> {
//       let content: RemoteResponseData | null = null;
...
//       };
//   }
//   public async fetchBranches(context: StorageTypeCredentials) {
//     switch (context.provider) {
//       case StorageProviderType.GITHUB:
...
//     }
//   }
//   public async addNewBranch(context: StorageTypeCredentials, branch: string, source?: string) {
...
//   }
//   public async fetchTokensFromFileOrDirectory({
//     files,
//     usedTokenSet,
//     activeTheme,
//   }: {
...
//       return null;
//   }
//   public async checkRemoteChange(context: StorageTypeCredentials = api): Promise<boolean> {
//     async ():  => {
//       let hasChange = false;
//       switch (context?.provider) {
//         case StorageProviderType.JSONBIN: {
