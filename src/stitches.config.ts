...
export const {
  ...
  theme: {
    ...
    colors: {
      ...
      contextMenuBackground: 'var(--color-bg-menu)',
      contextMenuForeground: 'var(--color-text-menu)',
      contextMenuForegroundMuted: 'var(--color-text-menu-muted)',
      contextMenuSeperator: 'var(--color-border-menu)',
      text: 'var(--color-text)',
      textMuted: 'var(--color-text-secondary)',
      textSubtle: 'var(--color-text-tertiary)',
      textDisabled: 'var(--color-text-disabled)',
      fgSubtle: 'var(--color-text-secondary)',
      bgSubtle: 'var(--color-bg-secondary)',
      bgAccent: 'var(--color-bg-selected-tertiary)',
      bgAccentHover: 'var(--color-bg-selected-hover)',
      interaction: 'var(--color-bg-brand)',
      interactionSubtle: 'var(--color-bg-brand-secondary)',
      onInteraction: 'var(--color-text-menu-onselected)',
      interactionDisabled: 'var(--color-text-menu-disabled)',
      dangerFg: 'var(--color-text-danger)',
