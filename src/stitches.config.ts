...
export const {
  ...
  theme: {
    ...
    colors: {
      ...
      contextMenuForegroundMuted: 'var(--figma-color-text-menu-muted)',
      ...
      onInteraction: 'var(--figma-color-text-menu-onselected)',
      ...
      fgBtnPrimary: 'var(--figma-color-text-menu-onselected)',
