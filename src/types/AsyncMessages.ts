...
import type { UpdateMode } from './state';
...
export type CreateStylesAsyncMessageResult = AsyncMessage<AsyncMessageTypes.CREATE_STYLES, { styleIds: Record<string, string>; }>;
