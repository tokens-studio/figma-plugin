  ...
  const availableThemeOptions = useMemo(() => (
    groupNames.map((groupName) => {
      ...
      return (
        ...
        <DropdownMenuRadioGroup key={groupName} className="content scroll-container" css={{ maxHeight: '70vh' }} value={typeof activeTheme[groupName] !== 'undefined' ? activeTheme[groupName] : ''}>
