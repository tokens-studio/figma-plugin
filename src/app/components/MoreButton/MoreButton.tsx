...
export const MoreButton: React.FC<Props> = ({ token, type, showForm }) => {
  ...
  return (
    <ContextMenu.ContextMenu>
      <ContextMenu.ContextMenuTrigger id={`${token.name}-button}`}>
      ...
      <ContextMenu.ContextMenuContent sideOffset={5} collisionTolerance={30}>
        ...
        <ContextMenu.ContextMenuItem onSelect={handleDuplicateClick} disabled={editProhibited}>
          Duplicate Token
        </ContextMenu.ContextMenuItem>
        <ContextMenu.ContextMenuItem disabled={editProhibited}>
          <CopyToClipboard text={token.name}>
            <span>Copy token path</span>
          </CopyToClipboard>
        </ContextMenu.ContextMenuItem>
        <ContextMenu.ContextMenuItem onSelect={handleDeleteClick} disabled={editProhibited}>
          Delete Token
        </ContextMenu.ContextMenuItem>
      </ContextMenu.ContextMenuContent>
    </ContextMenu.ContextMenu>
