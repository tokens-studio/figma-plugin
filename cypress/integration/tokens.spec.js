...
describe('TokenListing', () => {
  ...
  it('can add a new composition token', () => {
    ...
    cy.get('[daty-cy=composition-property]').click();
    cy.get('[daty-cy=composition-property--sizing]').click();
    fillInput({
      input: 'alias',
      value: '{sizing.xs}',
    });
    ...
    cy.get('[daty-cy=composition-property]').eq(1).click();
    cy.get('[daty-cy=composition-property--opacity]').eq(1).click();
